...
class CustomerDashboardForAccounting extends Component {
    state = {
        ...
        visitId: 0,
        apptStatus: this.props.apptStatus
    };
    componentDidMount() {
        ...
        if (this.props.apptStatus == "Completed" || this.props.apptStatus == "Cancelled") {
            this.setState({
                openBill: true,
                openAcc: false,
            });
...
export default CustomerDashboardForAccounting;
